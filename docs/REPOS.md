...
| Repo | Packages |
|------|----------|
| **[idle](https://github.com/idlescreen/idle)** | idle-daemon, idle-cli, idle-savers |
| [render](https://github.com/idlescreen/render) | offline export |
| [packages](https://github.com/idlescreen/packages) | index |
| [brand](https://github.com/idlescreen/brand) | assets |
